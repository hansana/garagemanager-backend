using GarageManager.API.Infrastructure.Identity.Helpers;
using GarageManager.API.Infrastructure.Identity.Models;
using GarageManager.Application.DTOs.Account;
using GarageManager.Application.DTOs.Email;
...
namespace GarageManager.API.Infrastructure.Identity.Services
{
